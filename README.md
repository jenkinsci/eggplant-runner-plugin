...
<table>
  ...
  <tr>
      <td>26.2.0+4</td>
      <td><a href="https://plugins.jenkins.io/eggplant-runner/"><a href="https://updates.jenkins.io/download/plugins/eggplant-runner/0.0.1.306.v3b_311e4c99e2/eggplant-runner.hpi"> 0.0.1.306.v3b_311e4c99e2 </a></td>
  </tr>
  <tr>
      <td>26.1.0+4</td>
...
3. **Action Required for DAI 26.2.0 upgrades to 26.2.1:** If you are upgrading from a plugin version from 26.2.0 to 26.2.1, you must resave all existing job configurations that use Model-Based or Script-Based test configurations. This is required to set the `spaceName` field which was introduced in DAI 26.2.1. Without resaving, jobs will fail with the error "Space with name 'null' not found". To resave:
